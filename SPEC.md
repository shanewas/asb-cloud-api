...
## 17. Screenshots (v1 Delivery Model)
...
- Retention policy, cleanup, and storage quotas are the operator's responsibility. No auto-deletion or background purge job exists in v1. Recommended: use a tmpfs/ramdisk for the dir, or run a periodic cleanup (e.g., find -mtime +1 -delete).
